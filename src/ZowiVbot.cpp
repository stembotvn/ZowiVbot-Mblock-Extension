...
void ZowiVbot::init(int YL, int YR, int RL, int RR, bool load_calibration, int NoiseSensor, int Buzzer, int USTrigger, int USEcho) {
...
//-- OSCILLATORS TRIMS ------------------------------------------//
///////////////////////////////////////////////////////////////////
void ZowiVbot::setTrims(int YL, int YR, int RL, int RR) {
  servo[0].SetTrim(YL);
  servo[1].SetTrim(YR);
  servo[2].SetTrim(RL);
  servo[3].SetTrim(RR);
...
///////////////////////////////////////////////////////////////////
void ZowiVbot::_moveServos(int time, int  servo_target[]) {
...
void ZowiVbot::oscillateServos(int A[4], int O[4], int T, double phase_diff[4], float cycle=1){
...
void ZowiVbot::_execute(int A[4], int O[4], int T, double phase_diff[4], float steps = 1.0){
...
bool ZowiVbot::getRestState(){

    return isOttoResting;
}

void ZowiVbot::setRestState(bool state){
...
//--    T: Period
//---------------------------------------------------------
void ZowiVbot::jump(float steps, int T){
...
//---------------------------------------------------------
void ZowiVbot::walk(float steps, int T, int dir){
...
//---------------------------------------------------------
void ZowiVbot::turn(float steps, int T, int dir){
...
//---------------------------------------------------------
void ZowiVbot::shakeLeg (int steps,int T,int dir){
...
//---------------------------------------------------------
void ZowiVbot::updown(float steps, int T, int h){
...
//---------------------------------------------------------
void ZowiVbot::swing(float steps, int T, int h){
...
//--     h : Amount of swing (from 0 to 50 aprox)
//---------------------------------------------------------
void ZowiVbot::tiptoeSwing(float steps, int T, int h){
...
//---------------------------------------------------------
void ZowiVbot::jitter(float steps, int T, int h){
...
//---------------------------------------------------------
void ZowiVbot::ascendingTurn(float steps, int T, int h){
...
//--    dir: Direction: LEFT / RIGHT
//---------------------------------------------------------
void ZowiVbot::moonwalker(float steps, int T, int h, int dir){
...
//--     dir:  Direction: LEFT / RIGHT
//-----------------------------------------------------------
void ZowiVbot::crusaito(float steps, int T, int h, int dir){
...
//---------------------------------------------------------
void ZowiVbot::flapping(float steps, int T, int h, int dir){
...
//---------------------------------------------------------
double ZowiVbot::getBatteryLevel(){
...
double ZowiVbot::getBatteryVoltage(){
...
void ZowiVbot::_tone (float noteFrequency, long noteDuration, int silentDuration){
    ...
    // delay(500);
      ...
      tone(ZowiVbot::pinBuzzer, noteFrequency, noteDuration);
...
void ZowiVbot::bendTones (float initFrequency, float finalFrequency, float prop, long noteDuration, int silentDuration){
...
void ZowiVbot::sing(int songName){
  switch(songName){
